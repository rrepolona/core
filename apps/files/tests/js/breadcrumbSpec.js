...
describe('BreadCrumb tests', function() {
	describe('Rendering', function() {
		...
		it('Renders root by default', function() {
			...
			expect($crumbs.eq(0).find('a').attr('href')).toEqual(OC.webroot + '/index.php/apps/files?dir=%2F');
		...
		it('Renders single path section', function() {
			...
			expect($crumbs.eq(0).find('img').length).toEqual(1);
			expect($crumbs.eq(0).attr('data-dir')).toEqual('/');
			expect($crumbs.eq(1).find('a').attr('href')).toEqual(OC.webroot + '/index.php/apps/files?dir=%2Fsomedir');
		...
		it('Renders multiple path sections and special chars', function() {
			...
			expect($crumbs.eq(2).find('a').attr('href')).toEqual(OC.webroot + '/index.php/apps/files?dir=%2Fsomedir%2Fwith%20space');
			expect($crumbs.eq(2).find('img').length).toEqual(0);
			expect($crumbs.eq(2).attr('data-dir')).toEqual('/somedir/with space');

			expect($crumbs.eq(3).find('a').attr('href')).toEqual(OC.webroot + '/index.php/apps/files?dir=%2Fsomedir%2Fwith%20space%2Fabc');
