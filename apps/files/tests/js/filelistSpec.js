...
describe('FileList tests', function() {
	...
	describe('Renaming files', function() {
		...
		it('Correctly updates file link after rename', function() {
			...
			expect($tr.find('a.name').attr('href')).toEqual('/index.php/apps/files/download/subdir/One_renamed.txt');
		});
		...
		xit('Correctly updates file link after rename when path has same name', function() {
			...
			$tr = FileList.findFileEl('One_renamed.txt');
			expect($tr.find('a.name').attr('href')).toEqual('/index.php/apps/files/download/One.txt/subdir/One_renamed.txt');
		});
	});
	...
	describe('file previews', function() {
		...
		it('renders provided icon for file when provided and no preview is available', function() {
			var fileData = {
				type: 'file',
				name: 'test dir',
		...
		it('renders provided icon first, then preview when available', function() {
			var fileData = {
				type: 'file',
				name: 'test dir',
				icon: OC.webroot + '/core/img/filetypes/application-pdf.png',
